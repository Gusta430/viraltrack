  ...
  try {
    ...
    if (p === '/api/tracks' && method === 'POST') {
      ...
      const track = {
        ...
        main_goal: fields.main_goal || null, lyrics: fields.lyrics || null, social_vibe: fields.social_vibe || null, no_social: fields.no_social || '0', target_region: fields.target_region || null, status: fields.status || 'uploaded',
      };
